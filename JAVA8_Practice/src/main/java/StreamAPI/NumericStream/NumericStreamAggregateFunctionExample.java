...
public class NumericStreamAggregateFunctionExample {
    ...
    public static void main(String[] args) {
       ...
       OptionalLong optionalLong = LongStream.rangeClosed(50,100).min();
        ...
        OptionalDouble optionalDouble = IntStream.rangeClosed(1,50).average(); //average() always return OptionalDouble
